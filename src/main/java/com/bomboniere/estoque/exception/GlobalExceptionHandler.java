...
public class GlobalExceptionHandler {
 ...
 @ExceptionHandler(ObjectOptimisticLockingFailureException.class) ResponseEntity<ApiError> concorrencia(ObjectOptimisticLockingFailureException e){ return resposta(HttpStatus.CONFLICT,"O produto foi atualizado por outra operação. Tente novamente."); }
